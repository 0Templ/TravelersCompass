...
import com.nine.travelerscompass.client.event.ClientEvents;
...
@Mod.EventBusSubscriber(modid = TCCommon.MODID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)

...
public record ContainerEntityLocationObject(BlockPos blockPos, int slotIndex, boolean priority, String descriptionId, String contentId, UUID uuid) implements ILocationObject, WithContent, WithUUID {
    
    public static ResourceLocation TYPE = ResourceLocation.fromNamespaceAndPath(TCCommon.MODID, "container_entity_location_codec");

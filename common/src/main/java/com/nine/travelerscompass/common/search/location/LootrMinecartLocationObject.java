...
public record LootrMinecartLocationObject(BlockPos blockPos, int slotIndex, boolean priority, String descriptionId, String contentId, UUID uuid) implements ILocationObject, WithContent, WithUUID {
    
    public static ResourceLocation TYPE = new ResourceLocation(TCCommon.MODID, "lootr_minecart_location_codec");

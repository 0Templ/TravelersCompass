...
//      REQUIRES_VALIDATION
    ...
    public static <T> void putDefaultToServer(ItemStack stack, DataStorage<T> data) {
        data.sendToServer(stack, data.defaultValue());
    }
    ...
    public static void toggleToServer(ItemStack stack, DataStorage<?> data, boolean forward) {
        ...
        if (current instanceof Boolean v) {
            ((DataStorage<Boolean>)data).sendToServer(stack, !v);
            ...
            ((DataStorage<Enum<?>>)data).sendToServer(stack, next);
        } else {
    ...
    public static final DataStorage<Integer> CE_VD_PROP = register(
            "ce_vd_prop", 1, (v -> Math.clamp(v,-1, 8)), Codec.INT, ByteBufCodecs.INT, RegistrationOption.CLIENT_EDITABLE);
    ...
    public static final DataStorage<HeightAttitude> TARGET_HEIGHT = register(
            "target_attitude", HeightAttitude.NONE, MoreCodecs.enumCodec(HeightAttitude.class), MoreCodecs.enumStreamCodec(HeightAttitude.class));
    ...
    public static final DataStorage<Boolean> HEIGHT_MARKER = register(
            "attitude_marker", true, Codec.BOOL, ByteBufCodecs.BOOL, RegistrationOption.CLIENT_EDITABLE);
    ...
    public static final DataStorage<Boolean> MINECARTS = register(
            "minecarts", true, Codec.BOOL, ByteBufCodecs.BOOL, RegistrationOption.SEARCH_OPTION, RegistrationOption.CLIENT_EDITABLE);

    public static final DataStorage<Boolean> CONTAINERS_CHESTS = register(
            "containers_chests", true, Codec.BOOL, ByteBufCodecs.BOOL, RegistrationOption.SEARCH_OPTION, RegistrationOption.CLIENT_EDITABLE);

    public static final DataStorage<LootrSearchMode> LOOTR_MODE = register(
            "lootr_search_mode", LootrSearchMode.CLOSED, MoreCodecs.enumCodec(LootrSearchMode.class), MoreCodecs.enumStreamCodec(LootrSearchMode.class), RegistrationOption.SEARCH_OPTION, RegistrationOption.CLIENT_EDITABLE);

...
public class PropertiesRegistry {
    ...
    public static void init(){
        ItemPropertiesAccessor.travelerscompass$register(ItemRegistry.TRAVELERS_COMPASS.get(), ResourceLocation.parse("angle"),
                new CustomCompassItemPropertyFunction((level, stack, entity)
                        -> TravelersCompassItem.getFoundPos(stack).blockPos()
                )
        );
        ItemPropertiesAccessor.travelerscompass$register(ItemRegistry.TRAVELERS_COMPASS.get(), ResourceLocation.parse("state"),
                new StatePropertyFunction()
        );
        ItemPropertiesAccessor.travelerscompass$register(ItemRegistry.TRAVELERS_COMPASS.get(), ResourceLocation.parse("priority_found"),

    ...
    public HudButton(int x, int y, Supplier<ItemStack> supplier) {
        ...
        NewRangePopupElement<Integer> widthElement = new NewRangePopupElement<>(9, 9,
...

            {
                ...
                this.cachedSize = CompassProperties.HUD_SIZE.get(supplier.get());
                updateState();
            }
            ...
            public void updateState(){
                ...
                this.cachedType = CompassProperties.HUD_TYPE.get(supplier.get());
                this.cachedSize = CompassProperties.HUD_SIZE.get(supplier.get());
                this.cached = CompassProperties.HUD_SIZE.get(stack).getWidth(cachedType);
                refreshTooltip();
            ...
            public void set(Integer value){
                CompassProperties.HUD_SIZE.sendToServer(supplier.get(), cachedSize.withWidth(cachedType, value));
            }
        };
        ...
        NewRangePopupElement<Integer> heightElement = new NewRangePopupElement<>(9, 9,
            ...
            public void updateState(){
                ...
                this.cachedType = CompassProperties.HUD_TYPE.get(supplier.get());
                this.cachedSize = CompassProperties.HUD_SIZE.get(supplier.get());
                this.cached = CompassProperties.HUD_SIZE.get(stack).getHeight(cachedType);
                refreshTooltip();
                ClientData.HUD_DATA_CACHE.computeIfPresent(uuid, (id, hudData) -> {
                    HudSettings settings = hudData.getSettings();
            ...
            @Override
            public void set(Integer value){
                CompassProperties.HUD_SIZE.sendToServer(supplier.get(), cachedSize.withHeight(cachedType, value));
            }
        };
        ...
        NewPopupElement hudTypeElement = new NewPopupElement(9, 9) {
            ...
            public void onClick(int button){
                CompassProperties.toggleToServer(supplier.get(), CompassProperties.HUD_TYPE, button == 1);
                updateState();
        ...
        NewPopupElement hucChatElement = new NewPopupElement(9, 9) {
            ...
            @Override
            public void onClick(int button){
                CompassProperties.toggleToServer(supplier.get(), CompassProperties.HUD_WITH_CHAT, button == 1);
                updateState();
            }
        ...
        NewPopupElement hudAlignmentButton = new NewPopupElement(9, 9) {
            ...
            @Override
            public void onClick(int button){
                CompassProperties.toggleToServer(supplier.get(), CompassProperties.HUD_ALIGNMENT, button == 1);
                updateState();
            }

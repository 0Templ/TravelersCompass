...
public class HudRenderer {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(TCCommon.MODID, "textures/gui/gui_components.png");
    public static final ResourceLocation EDGES_TEXTURE = new ResourceLocation(TCCommon.MODID, "textures/gui/hud_edges.png");

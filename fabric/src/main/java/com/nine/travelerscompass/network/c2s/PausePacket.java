...
public class PausePacket extends FriendlyByteBuf {

    public static final ResourceLocation ID = new ResourceLocation(TCCommon.MODID, "pause_packet");
        ...
        server.execute(() -> {
            ...
            if (stack.getItem() instanceof TravelersCompassItem
             && Objects.equals(CompassProperties.COMPASS_UUID.get(stack), uuid)){
                ...
                SearchManager.removeWatcher(uuid, player);
